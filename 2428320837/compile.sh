...
clang "$1" -o "$compname" -ObjC -arch armv7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -fexceptions -fasm-blocks -Wprotocol -Wdeprecated-declarations -Wno-sign-conversion -emit-llvm -S $3
status=$?
if [ $status -eq 0 ]
then
echo $compname
